...
# Author: Visi@n antonio@tsurugi-linux.org
...
class Parser:
    def __init__(self, input_path = './ics/', output_path = './csv/', time_zone = 'Europe/Rome', tag_dict = {}):
...
if __name__ == '__main__':
    ...
    p.tagging()
    p.output(start_date = '1980-12-01', end_date = '2023-04-07')
